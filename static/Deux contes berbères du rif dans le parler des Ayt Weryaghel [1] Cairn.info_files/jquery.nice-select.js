...
(function($) {
    ...
    $.fn.niceSelect = function(method) {
        ...
        function create_nice_select($select) {
            ...
            var selected_icon = $selected.attr('data-icon');
            var selected_html = $selected.html();
            if (typeof selected_class_attr !== typeof undefined && selected_class_attr !== false) {
                selected_html = '<span class="' + selected_class_attr + '">' + selected_icon + '</span>' + selected_html;
            }
            ...
            $options.each(function(i) {
                ...
                if (typeof class_attr !== typeof undefined && class_attr !== false) {
                    option_html = '<span class="' + class_attr + '">' + attr_icon + '</span>'+ $option.text();
                }
        ...
        $(document).on('click.nice_select', '.nice-select .option:not(.disabled)', function(event) {
            ...
            var selected_class_attr = $option.attr('data-class');
            var selected_icon = $option.attr('data-icon');
            var selected_html = $option.html();
            if (typeof selected_class_attr !== typeof undefined && selected_class_attr !== false) {
                selected_html = '<span class="' + selected_class_attr + '">' + selected_icon + '</span>' + selected_html;
            }
