...
+function ($) {
    ...
    LimitText.prototype.checkCount = function () {
        ...
        var remaining = currVal.length + '/' + this.options.limit;
        
        this.$count.html(remaining);
        
        if (currVal.length >= this.options.limit - this.options.warningLimit) {
